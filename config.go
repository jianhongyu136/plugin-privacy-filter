...
func configFields() []pluginapi.ConfigField {
	return []pluginapi.ConfigField{
		{Name: "mode", Type: pluginapi.ConfigFieldTypeEnum, EnumValues: []string{modeFilter, modeBlock}, Description: "Request handling mode: filter replaces privacy values; block rejects with redacted context."},
